...
import scheduleImg from './assets/schedule.png'   // ⬅️ novo (sistema de agendamento)
import financeImg from './assets/finance.png'     // ⬅️ novo (dashboard financeiro)
    ...
    en: {
      ...
      portfolio:[
        ...
        },
        {
          ...
          category:'Web App',
          description:'Appointment booking with calendar, reminders and patient flow.',
          image: scheduleImg
        },
        {
          title:'Finance Dashboard',
          category:'Admin Panel',
          description:'Interactive BI analytics with KPIs, charts and real-time insights.',
          image: financeImg
        }
      ],
    ...
    pt: {
      ...
      portfolio:[
        ...
        },
        {
          ...
          description:'Agendamentos com calendário, lembretes e fluxo de pacientes.',
          image: scheduleImg
        },
        {
          title:'Dashboard Financeiro',
          category:'Painel Administrativo',
          description:'BI interativo com KPIs, gráficos e insights em tempo real.',
          image: financeImg
        }
      ],
