...
function App() {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Aquisição, avaliação e negociação de domínios premium alinhados à sua estratégia de marca",
  ...
  const portfolio = [
    { title: "E-commerce Fashion", category: "Loja Virtual", description: "Plataforma completa de vendas online com integração de pagamentos", gradient: "from-purple-500 to-pink-500" },
    { title: "Tech Startup", category: "Website Corporativo", description: "Site institucional moderno para startup de tecnologia", gradient: "from-blue-500 to-cyan-500" },
    { title: "Restaurant App", category: "Aplicação Web", description: "Sistema de pedidos online com gestão de cardápio", gradient: "from-orange-500 to-red-500" },
    { title: "Finance Dashboard", category: "Painel Administrativo", description: "Dashboard interativo para análise de dados financeiros", gradient: "from-green-500 to-emerald-500" }
  ]

  const testimonials = [
    { name: "Maria Silva", company: "Tech Solutions", text: "A Global Domain Ventures transformou completamente nossa presença online. Profissionalismo excepcional!", rating: 5 },
    { name: "João Santos", company: "Inovare Group", text: "Entrega rápida, design impecável e suporte contínuo. Recomendo fortemente!", rating: 5 },
    { name: "Ana Costa", company: "Digital Marketing Pro", text: "Parceria estratégica que elevou nossos resultados digitais a outro nível.", rating: 5 }
  ]
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }}>
            ...
            <div className="flex gap-4 justify-center flex-wrap">
              <Button
                ...
                onClick={() => (window.location.href = 'mailto:contato@globaldomainventures.com')}
              >
        ...
        <div className="container mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-slate-400 text-sm">
                <li className="hover:text-cyan-400 cursor-pointer transition-colors">contato@globaldomainventures.com</li>
                <li className="hover:text-cyan-400 cursor-pointer transition-colors">+55 31 99519-5540</li>
